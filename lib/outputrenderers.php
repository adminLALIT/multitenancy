...
class renderer_base {
    ...
    public function get_compact_logo_url($maxwidth = 300, $maxheight = 300) {
        ...
        // IOMAD
        if (!empty($SESSION->currenteditingcompany)) {
            // If custom logo is setup.
            if ($customlogo = $DB->get_record('brandetails', ['companyid' => $SESSION->currenteditingcompany])) {
                require_once($CFG->dirroot.'/local/brandconfig/lib.php');
                return get_logo_by_brandid($customlogo->id);
            }
