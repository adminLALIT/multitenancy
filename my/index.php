...
$selectrole  = optional_param('role', null, PARAM_RAW);
...
$params = array();
if (!is_null($selectrole)) {
    $selected = $selectrole;
    $params['role'] = $selectrole;
}
...
$rolesarray['admin'] = get_string('superadmin', 'my');
$rolesarray['companymanager'] = get_string('tenantadmin', 'my');
$rolesarray['teacher'] = get_string('tutors', 'my');
$rolesarray['student'] = get_string('learners', 'my');
$rolesarray['guest'] = get_string('guest');

if (has_capability('local/brandconfig:siteadmin', context_system::instance())) {
    echo $OUTPUT->single_select(
        ...
        $formid = null,
        ['label' => get_string('selectrole', 'my')]
    );
}
